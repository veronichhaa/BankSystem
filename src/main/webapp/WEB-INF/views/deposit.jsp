...
<div class="container">
    <c:if test="${pageContext.request.userPrincipal.name != null}">
        ...
        <div class="section">
            <div class="form">
                <form class="form_body" method="post" action="${contextPath}/deposit" modelAttribute="depositForm">
                    <h2 class="form_header">Открыть депозит</h2>
                    <div class="form-text"> Процентная ставка: 9%</div>
                    ...
                    <br>
                    <button class="button" type="submit">Открыть депозит</button>
